...
const list = [
  {
    ...
    value: 'Комментарий',
    svg: <svg className={styles.itemSvg} width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    className: styles.item,
    value: 'Поделиться',
    svg: <svg className={styles.itemSvg} width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    className: `${styles.item} ${styles.itemModil}`,
    value: 'Скрыть',
    svg: <svg className={styles.itemSvg} width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    className: `${styles.item} ${styles.itemModil}`,
    value: 'Пожаловаться',
    svg: <svg className={styles.itemSvg} width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
